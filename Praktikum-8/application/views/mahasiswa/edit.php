                ...
                <div class="form-group row">
                    ...
                    <select id="prodi" name="prodi" class="custom-select">
                        <?php
                            ...
                            $selected_TI = ($mhs_edit->prodi_kode == "TI")?"selected":"";
                            $selected_SI = ($mhs_edit->prodi_kode == "S!")?"selected":"";
                            $selected_BD = ($mhs_edit->prodi_kode == "BD")?"selected":"";

                        ?>
                        <option value="SI" <?= $selected_SI;?> > Sistem Informasi</option>
                        <option value="TI" <?= $selected_TI;?> >Teknik Informatika</option>
                        <option value="BD" <?= $selected_BD;?>>Bisnis Digital</option>
                    </select>
                    </div>
                </div>
                <div class="form-group row">
